...
public class MinistryController {
    ...
    @PostMapping
    public ResponseEntity<Ministry> create(@RequestBody CreateMinistryRequest req) {
    ...
    public ResponseEntity<List<PotentialMemberDto>> potentialMembers(@PathVariable UUID id) {
